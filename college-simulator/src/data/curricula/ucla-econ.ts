...
export const uclaEcon: Curriculum = {
  ...
  courses: [
    ...
    { id: 'HIST1A', title: 'Western Civilization: Ancient to Medieval', description: 'Greece, Rome, Christianity, Islam, feudalism, and the medieval world. Foundations of Western thought.', credits: 5, category: 'elective', interestTags: ['history', 'classics'], prereqs: [], genEdReqs: ['social-science'] },
    { id: 'HIST1B', title: 'Western Civilization: Early Modern to Present', description: 'Renaissance, Reformation, Enlightenment, revolutions, world wars, and the postwar world.', credits: 5, category: 'elective', interestTags: ['history'], prereqs: [], genEdReqs: ['social-science'] },
    { id: 'HIST8A', title: 'African History to 1800', description: 'Ancient Nubia, Great Zimbabwe, Mali Empire, the slave trade, and African civilizations before colonialism.', credits: 5, category: 'elective', interestTags: ['history'], prereqs: [], genEdReqs: [] },
