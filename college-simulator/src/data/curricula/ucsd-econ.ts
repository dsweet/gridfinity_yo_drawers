...
export const ucsdEcon: Curriculum = {
  ...
  courses: [
    ...
    // ===== ASTRONOMY / SPACE =====
    { id: 'PHYS5', title: 'Stars, Black Holes & the Universe', description: 'Non-majors astronomy: stellar evolution, black holes, galaxies, dark matter, and cosmology.', credits: 4, category: 'elective', interestTags: ['astronomy', 'space'], prereqs: [], genEdReqs: ['natural-science'] },
    { id: 'PHYS7', title: 'The Solar System & Beyond', description: 'Planets, moons, exoplanets, and the search for life. Planetary science and space exploration.', credits: 4, category: 'elective', interestTags: ['astronomy', 'space'], prereqs: [], genEdReqs: ['natural-science'] },
    { id: 'SIO10', title: 'The Earth', description: 'Earth as a system: oceans, atmosphere, climate, plate tectonics, and natural hazards. Scripps Institution of Oceanography.', credits: 4, category: 'elective', interestTags: ['space'], prereqs: [], genEdReqs: ['natural-science'] },
    { id: 'SIO15', title: 'Natural Disasters', description: 'Earthquakes, volcanoes, tsunamis, hurricanes, and their impact on civilization. Risk assessment and preparedness.', credits: 4, category: 'elective', interestTags: ['space'], prereqs: [], genEdReqs: ['natural-science'] },
    { id: 'SIO45', title: 'Oceanography', description: 'Physical, chemical, biological, and geological oceanography. Marine ecosystems and ocean-climate connections.', credits: 4, category: 'elective', interestTags: ['space'], prereqs: [], genEdReqs: ['natural-science'] },
    { id: 'PHYS1A', title: 'Mechanics', description: 'Algebra-based mechanics: kinematics, forces, energy, momentum, and rotational motion. Lab included.', credits: 4, category: 'gen-ed', interestTags: ['space'], prereqs: [], genEdReqs: ['natural-science'] },
    ...
    { id: 'BILD1', title: 'The Cell', description: 'Cell biology: structure, function, genetics, and molecular biology. Lab included.', credits: 4, category: 'gen-ed', interestTags: [], prereqs: [], genEdReqs: ['natural-science'] },
    { id: 'CHEM6A', title: 'General Chemistry I', description: 'Atoms, molecules, bonding, stoichiometry, and thermochemistry. Lab included.', credits: 4, category: 'gen-ed', interestTags: [], prereqs: [], genEdReqs: ['natural-science'] },
